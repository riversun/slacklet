...
public interface SlackSession {
  ...
  // Added 2018/02/04 for sending "presence_sub" message via websocket by sending
  // raw approach
  SlackMessageHandle<SlackMessageReply> sendRawMessageOverWebSocket(JsonObject messageJSON);
  ...
  SlackMessageHandle<SlackMessageReply> sendPresenceSubMessageOverWebSocket(String[] ids);
